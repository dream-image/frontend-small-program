	...
	<view
		...
		<view style="height: 46px;overflow: hidden;position: absolute;width: 100%;height: 100%;" class="items">
			<van-nav-bar title="" left-text="返回" left-arrow @click-left="onClickLeft">
				<template #right>
					<view style="position: relative;width: max-content;color: #6389fa;">
						<span>挑战排行榜</span>
						<van-icon name="arrow" size="18" @click="onClickRight" style="top: 4rpx;bottom: 0;margin: auto;position: relative;" />
					</view>
		...
		<view style="grid-row-start: 3;grid-row-end: 16	;position: relative;" class="items">
			<view
				...
				<view v-for="i,index in personList" :key="index"
					style="display: flex;width: 90%;justify-content: space-around;font-size: 27rpx;position: relative;left: 0;right: 0;margin: auto;"
					class="items">
		...
		<view style="grid-row-start: 16;grid-row-end: 18;position: relative;" class="items">
			<view style="width: 95%; height: 98%;position: absolute;left: 0;right: 0;margin: auto;top: 0;bottom: 0;"
				...
				<view
					...
					<view
						style="height: 60rpx;width: 60rpx;border-radius: 100%;border: 2px solid black;position: relative;top: 0;bottom: 0;margin-top: auto;
						margin-bottom: auto;background-image: url(https://cube.elemecdn.com/3/7c/3ea6beec64369c2642b92c6726f1epng.png);background-repeat: no-repeat;
...
<style>
	...
	@font-face {
		font-family: "阿里妈妈东方大楷";
		font-weight: 400;
		src: url("//at.alicdn.com/wf/webfont/f2wEXLd1xeef/y506gcot6pEC.woff2") format("woff2"),
			url("//at.alicdn.com/wf/webfont/f2wEXLd1xeef/2IzbyGKmoRN4.woff") format("woff");
		font-display: swap;
	}
</style>