    ...
    " id="wrapper">
      ...
      " class="items">
        ...
        ">
					...
					<span
						style="position: absolute;top: 0;bottom: 0; left: 0;right: 0;margin:auto;width: max-content;height: min-content;">封神榜</span>
				</view>
				<view style="position: absolute;left: 0;right: 0;bottom: -35rpx;margin: auto;width: 250rpx;text-align: center;
			font-family: '阿里妈妈东方大楷';color: #8d18cc;
          ...
          " v-for="item,index in questionList[0].option.split('#')" :key="index"
			...
			<view style="grid-row-start: 13; grid-row-end: 16;position: relative;" class="items">
				<view
					...
					<view>
						<van-button round color="#ffc400" @click="star" :disabled="userInformation.who=='游客'"><van-icon
								name="star" :color="starColor" />收藏</van-button>
					</view>
					<view>
						<van-button round color="#ffc400" @click="reduce">不会</van-button>
					</view>
					<view>
						<van-button round color="#ffc400" @click="gotoNext">下一题</van-button>
					</view>
				</view>
